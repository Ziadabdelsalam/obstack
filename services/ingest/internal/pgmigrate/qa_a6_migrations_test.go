...
func TestQAA6InheritedFilesAreUndriftedByS33(t *testing.T) {
	...
	const want = "0001_workspaces,0002_saved_views,0003_auth,0004_api_keys,0005_metering,0006_explain_quota,0007_health_windows,0008_metrics_health,0009_dashboards,0010_alerts,0011_change_events,0012_slos,0013_incidents"
	if got != want {
