...
export function IncidentRca({ incident }: { incident: Incident }) {
  ...
  const copyMarkdown = () => {
    const md = [
      ...
      `---`,
      // Source list = a capability claim. Cluster events reach `k8sEvents`
      // only through the chart's events collector (Kubernetes deployments);
      // they were removed here in S4.4 R3 while nothing ingested them, and
      // naming them again is a copy ruling, not something this file decides.
