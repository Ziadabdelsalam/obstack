/**
 * The issues surface, mock branch (D367): today's `app/app/issues/page.tsx`
 * body moved here VERBATIM — same imports, same `statusStyle`, same inline
 * `Spark`, same markup — so the rendered DOM in mock mode is byte-identical to
 * what it was before the page learned to branch. It takes no props and reads
 * `@/mock/issues` itself, exactly as the page did.
 */
