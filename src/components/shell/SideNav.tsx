...
const items = [
  ...
  { href: "/app/traces", label: "Traces", icon: ListTree, exact: false },
  { href: "/app/connections", label: "Connections", icon: Plug, exact: false },
  { href: "/app/onboarding", label: "Quickstart", icon: Rocket, exact: false },
...
export function SideNav() {
  ...
  return (
    <aside className="flex h-screen w-[216px] shrink-0 flex-col border-r border-line bg-surface">
